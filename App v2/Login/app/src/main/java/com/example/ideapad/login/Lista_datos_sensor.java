...
public class Lista_datos_sensor extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_datos_sensor);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);

        listaview_DS = (ListView) findViewById(R.id.lista_DS);
    ...
    private void consulta_tareas() {
        ...
        Cursor fila = bd.rawQuery("select * from L_datoS", null);
        ...
        if(fila.moveToFirst()){
            ...
            for (fila.moveToFirst(); !fila.isAfterLast(); fila.moveToNext()) {
                ...
                lista_informacion.add("Tarea N°: " + fila.getString(1) + " --- Sensor: " + fila.getString(2) + " --- Humedad: " + fila.getString(3) + "%");
        ...
        listaview_DS.setAdapter(adaptador);
    }
